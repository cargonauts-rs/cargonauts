...
pub trait _MaybeAttachHasOne<Rel: ToOne, P, R: Router> {
    fn attach(_: &mut R) { }
}

impl<T: Resource, Rel: ToOne, P, R: Router> _MaybeAttachHasOne<Rel, P, R> for T { }

impl<T, Rel, P, R> _MaybeAttachHasOne<Rel, P, R> for T
where
    T: HasOne<Rel>,
    Rel: ToOne,
    P: Presenter<(), R>,
